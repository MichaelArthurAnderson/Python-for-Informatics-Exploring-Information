...
#  Exercise 6.4 There is a string method called count that is similar to the function in the previous exercise. Read the documentation of this method at docs.python.
...
print "a appears in banana " + str('banana'.count('a')) + " times."
